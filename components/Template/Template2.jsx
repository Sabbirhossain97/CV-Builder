...
function Template2({ save, load, loading, exportJSON, importJSON, draftLoading }) {
    const targetRef = useRef();
    const importInputRef = useRef(null);
    const [colors, setColors] = useState("");
    const { imageUrls, personalInformation, summary, employment, education, socials, skills, project, certification, extraCurricular, languages, hobbies, reference, skillExpLevel, langLevel, previewTemplate, profileCompleteness } = useContext(DataContext);
